      ...
      <Stack className=" px-5 flex flex-col gap">
        <Group justify="space-between" align="end" gap="md">
          <Text maw={640} className="text-moss-700">
            {isSystemOwner
              ? 'Здесь отображаются все рестораны в системе с их текущим moderation-статусом, публикацией и бизнес-данными.'
              : 'Здесь отображаются ваши рестораны с актуальными статусами, контактами и параметрами доставки.'}
          </Text>
