      ...
      <Stack align="center" gap="md" maw={520} ta="center">
        ...
        <Stack gap={6}>
          ...
          <Text className="text-moss-600">
            После выбора ресторана слева появятся его активные категории, а
            здесь можно будет перейти к настройке структуры меню.
          </Text>
        </Stack>
      </Stack>
    </Flex>
...
export default NoActiveRestaurant
